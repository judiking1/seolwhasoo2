...
const spaProgram = [ {
  ...
  pcImg : `${process.env.PUBLIC_URL}/images/spa/spa-program/sulwhasoo-spa-program_img01_pc_kr.jpg`,
  moImg : `${process.env.PUBLIC_URL}/images/spa/spa-program/sulwhasoo-spa-program_img01_mo_kr.jpg`,
  alt : "spa-program1",
  ...
  pcImg : `${process.env.PUBLIC_URL}/images/spa/spa-program/sulwhasoo-spa-program_img02_pc_kr.jpg`,
  moImg : `${process.env.PUBLIC_URL}/images/spa/spa-program/sulwhasoo-spa-program_img02_mo_kr.jpg`,
  alt : "spa-program2",
  ...
  pcImg : `${process.env.PUBLIC_URL}/images/spa/spa-program/sulwhasoo-spa-program_img03_pc_kr.jpg`,
  moImg : `${process.env.PUBLIC_URL}/images/spa/spa-program/sulwhasoo-spa-program_img03_mo_kr.jpg`,
  alt : "spa-program3",
  descTitle : "설화수 헤리티지 스파",
  descContent : ["Work of art 같은 제품들로 이뤄진 설화수만의 리추얼들로","최상의 피부상태를 만들어 본연의 아름다움을 찾아줍니다."],
  moreContents : false,
