...
const Section6 = () => {
  ...
  const bgPath = {
    ...
    pcBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_08_pc_kr.jpg)`,
    },
  };
  ...
  const section6Img = {
    mo: `${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_04_mo_kr.jpg`,
    pc: `${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_04_pc_kr.jpg`,
  };
