...
const Section7 = () => {
  ...
  const bgPath = {
    moBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_09_mo_kr.jpg)`,
    },
    pcBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_09_pc_kr.jpg)`,
    },
  };
