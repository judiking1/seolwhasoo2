...
const Section4 = () => {
  const bgPath = {
    moBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_03_mo_kr.jpg)`,
    },
    pcBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_03_pc_kr.jpg)`,
    },
  };
