...
const Section9 = () => {
  ...
  const bgPath = {
    moBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_07_mo_kr.jpg)`,
    },
    pcBackground: {
      backgroundImage: `url(${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_img_07_pc_kr.jpg)`,
    },
  };
  useEffect(() => {
    const handleResize = () => {
  ...
  const section9Img = {
    cream: {
      mo: `${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_product_01_mo_kr.png`,
      pc: `${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_product_01_pc_kr.png`,
    },
    serum: {
      mo: `${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_product_02_mo_kr.png`,
      pc: `${process.env.PUBLIC_URL}/images/ginseng/ginseng_cream_product_02_pc_kr.png`,
    },
  };
