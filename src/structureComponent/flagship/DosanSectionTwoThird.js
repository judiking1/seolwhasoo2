...
const SwiperBtn = styled.section`
@media only all and (min-width: 1024px) {
  &::after {
  background-image: url(${process.env.PUBLIC_URL}/images/flagship/icon/next.jpg);
  }
}`;
        ...
        <div className="swiper mySwiper">
          ...
          >
            <SwiperSlide ref={slideRef}>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide1.jpg`}
                alt="슬라이드1"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide1_pc.jpg`}
                alt="슬라이드1"
              />
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide2.jpg`}
                alt="슬라이드2"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide2_pc.jpg`}
                alt="슬라이드2"
              />
              <div className="swiper-text">
                <span className="floor">B1F</span>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide3.jpg`}
                alt="슬라이드3"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide3_pc.jpg`}
                alt="슬라이드3"
              />
              <div className="swiper-text">
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide4.jpg`}
                alt="슬라이드4"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide4_pc.jpg`}
                alt="슬라이드4"
              />
              <div className="swiper-text">
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide5.jpg`}
                alt="슬라이드5"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide5_pc.jpg`}
                alt="슬라이드5"
              />
              <div className="swiper-text">
                <span className="floor">2F</span>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide6.jpg`}
                alt="슬라이드6"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide6_pc.jpg`}
                alt="슬라이드6"
              />
              <div className="swiper-text">
                <span className="floor">2F</span>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide7.jpg`}
                alt="슬라이드7"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide7_pc.jpg`}
                alt="슬라이드7"
              />
              <div className="swiper-text">
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide8.jpg`}
                alt="슬라이드8"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide8_pc.jpg`}
                alt="슬라이드8"
              />
              <div className="swiper-text">
                <span className="floor">3F</span>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide9.jpg`}
                alt="슬라이드9"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide9_pc.jpg`}
                alt="슬라이드9"
              />
              <div className="swiper-text">
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide10.jpg`}
                alt="슬라이드10"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide10_pc.jpg`}
                alt="슬라이드10"
              />
              <div className="swiper-text">
                <span className="floor">4F</span>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide11.jpg`}
                alt="슬라이드11"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/dosan/slide11_pc.jpg`}
                alt="슬라이드11"
              />
              <div className="swiper-text">
