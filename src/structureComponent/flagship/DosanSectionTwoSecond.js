...
const PlayBtn = styled.section`
&::after {
  background-image: url(${process.env.PUBLIC_URL}/images/flagship/icon/play_white.svg);
}`;
...
function DosanSectionTwoSecond() {
  ...
  `url(${process.env.PUBLIC_URL}/images/flagship/dosan/video_thumbnail_dosan.jpg)`:
  `url(${process.env.PUBLIC_URL}/images/flagship/dosan/video_thumbnail_dosan_pc.jpg)`;
  ...
  return (
    <div className="sec_2_second ">
      ...
      <div data-aos="fade-up" className="video_area_cover">
        {!videoVisible && (
          <PlayBtn className="video_play_btn" onClick={handlePlayButtonClick} style={{backgroundImage:bgUrl}}>
            플레이버튼
          </PlayBtn>
        )}
