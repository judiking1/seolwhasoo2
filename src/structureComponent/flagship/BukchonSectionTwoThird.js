        ...
        <div className="swiper mySwiper_h">
          ...
          >
            <SwiperSlide ref={slideRef}>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide1_h_m.jpg`}
                alt="슬라이드1"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide1_h_p.jpg`}
                alt="슬라이드1"
              />
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide2_h_m.jpg`}
                alt="슬라이드2"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide2_h_p.jpg`}
                alt="슬라이드2"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide3_h_m.jpg`}
                alt="슬라이드3"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide3_h_p.jpg`}
                alt="슬라이드3"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide4_h_m.jpg`}
                alt="슬라이드4"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide4_h_p.jpg`}
                alt="슬라이드4"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide5_h_m.jpg`}
                alt="슬라이드5"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide5_h_p.jpg`}
                alt="슬라이드5"
              />
              <div className="swiper-text">
                <strong>
      ...
      >
        <div className="swiper mySwiper_y">
          ...
          >
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide1_y_m.jpg`}
                alt="슬라이드1"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide1_y_p.jpg`}
                alt="슬라이드1"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide2_y_m.jpg`}
                alt="슬라이드2"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide2_y_p.jpg`}
                alt="슬라이드2"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide3_y_m.jpg`}
                alt="슬라이드3"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide3_y_p.jpg`}
                alt="슬라이드3"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide4_y_m.jpg`}
                alt="슬라이드4"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide4_y_p.jpg`}
                alt="슬라이드4"
              />
              <div className="swiper-text">
                <strong>
            ...
            <SwiperSlide>
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide5_y_m.jpg`}
                alt="슬라이드5"
              />
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/buckshon_slide5_y_p.jpg`}
                alt="슬라이드5"
              />
              <div className="swiper-text">
                <strong>
