      ...
      <div className="sec_2_second_imgs_cover">
        <div className="sec_2_left_cover dTag">
          ...
          <div className="sec_2_second_img_1st">
            <span className="pc_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_1st_p.jpg`}
                alt="북촌역사1"
                data-aos-offset="300"
            ...
            <span className="mobile_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_1st_m.jpg`}
                alt="북촌역사1"
                data-aos="fade-right"
              />
            </span>
          ...
          <div className="sec_2_second_img_2nd">
            <div className="swiper mySwiper_sec2_pc pc_img_1st">
              ...
              >
                <SwiperSlide>
                  <img
                    src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_4th_p1.jpg`}
                    alt="북촌역사1"
                  />
                  </SwiperSlide>
                <SwiperSlide>
                  <img
                    src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_4th_p2.jpg`}
                    alt="북촌역사1"
                  />
                </SwiperSlide>
              </Swiper>
            ...
            <span className="mobile_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_2nd_m.jpg`}
                alt="북촌역사1"
                data-aos="fade-right"
              />
            </span>
        ...
        <div className="sec_2_right_cover dTag">
          <div className="sec_2_second_img_3rd">
            <div className="swiper mySwiper_sec2_pc pc_img_1st">
              ...
              >
                <SwiperSlide>
                  <img
                    src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_1st_p1.jpg`}
                    alt="북촌역사1"
                  />
                  </SwiperSlide>
                <SwiperSlide>
                  <img
                    src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_1st_p2.jpg`}
                    alt="북촌역사1"
                  />
                </SwiperSlide>
              </Swiper>
            ...
            <span className="mobile_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_3rd_m.jpg`}
                alt="북촌역사1"
                data-aos="fade-left"
              />
            </span>
          ...
          <div className="sec_2_second_img_4th">
            <span className="pc_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_2nd_p.jpg`}
                alt="북촌역사1"
                data-aos-offset="300"
                data-aos-duration="1500"
                data-aos="zoom-out"
            ...
            <span className="mobile_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_4th_m.jpg`}
                alt="북촌역사1"
                data-aos="fade-left"
              />
            </span>
          ...
          <div className="sec_2_second_img_5th dpNone_m">
            <span className="pc_img_1st">
              <img
                src={`${process.env.PUBLIC_URL}/images/flagship/bukchon/section2_2nd_img_3rd_p.jpg`}
                alt="북촌역사1"
                data-aos-offset="300"
                data-aos-duration="1500"
                data-aos="zoom-out"
