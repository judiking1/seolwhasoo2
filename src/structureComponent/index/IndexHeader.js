    ...
    <div>
        ...
        <div className="pc_header_inner">
          <div className="pc_lnb w1100">
            <div className="language_select">
              한국/한국어{" "}
              <img
                src={`${process.env.PUBLIC_URL}/images/main/icon/language_arrow_white.png`}
                alt="언어선택탭"
                id="language_icon"
              ></img>
            </div>
      ...
      <div className={`side_cover ${isOpen ? "open" : ""}`}>
        <div className={`side_header ${isOpen ? "open" : ""}`}>
          <Link to="#" className="orange_logo" style={{backgroundImage:logoBg}}></Link>
          <button className="close_btn" onClick={toggleMenu} style={{backgroundImage:closeBtnBg}}></button>
        </div>
          ...
          <div className="sideBox">
            <div className="side_content">
              <ul id="global_nav" className="nav_list">
                <li className="nav_d1">
                  <Link to="yunjo" className="no_depth_menu">
                    윤조
                  </Link>
                </li>
                <li className="nav_d1">
              ...
              <div className="other_info">
                ...
                <button type="button" className="mobile_select_language">
                  ...
                  <span className="language_select">
                    한국/한국어{" "}
                    <img
                      src={`${process.env.PUBLIC_URL}/images/main/icon/plus.png`}
                      alt="플러스아이콘"
                    ></img>
                  </span>
                </button>
