...
function WithSulwhasoo_sec() {
  const SwiperPrevBtn = window.innerWidth > 768? 
  `url(${process.env.PUBLIC_URL}/images/main/icon/swiper_arrow_prev.png)` : 
  `none`;
  
  const SwiperNextBtn = window.innerWidth > 768? 
  `url(${process.env.PUBLIC_URL}/images/main/icon/swiper_arrow_next.png)` : 
  `none`;
  return (
    <section className="sns_review w1440">
      <div className="with_sulwhasoo">
        ...
        <Swiper
          ...
          <div className="swiper-wrapper with_img_container">
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns01.webp`} alt="sns"></img>
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns02.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns03.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns04.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns05.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns06.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns07.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns08.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns09.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns10.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns11.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns12.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns13.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns14.webp` }alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
            ...
            <SwiperSlide className="swiper-slide with_img">
              <div className="img_section">
                <img src={`${process.env.PUBLIC_URL}/images/main/sns15.webp`} alt="sns"></img>
                <FontAwesomeIcon icon={faBagShopping} className="circle_icon" />
              </div>
              <div className="hover_content">
                <div className="sns_info">
          ...
          <button type="button" className="swiper-button swiper-button-sns sns_button_prev" style={{backgroundImage:SwiperPrevBtn}}></button>
          <button type="button" className="swiper-button swiper-button-sns sns_button_next" style={{backgroundImage:SwiperNextBtn}}></button>
        </Swiper>
      </div>
    </section>
  )
