...
function Recommend_sec() {
    const SwiperPrevBtn = `url(${process.env.PUBLIC_URL}/images/main/icon/swiper_arrow_prev.png)`;
    const SwiperNextBtn = `url(${process.env.PUBLIC_URL}/images/main/icon/swiper_arrow_next.png)`;
        ...
        <Swiper
            ...
            <ul className="swiper-wrapper recommend_card_swiper">
                <SwiperSlide className="swiper-slide">
                    <img src={`${process.env.PUBLIC_URL}/images/main/recommend_slide01.jpg`} alt="설화수추천제품"></img>
                ...
                <SwiperSlide className="swiper-slide">
                    <img src={`${process.env.PUBLIC_URL}/images/main/recommend_slide02.jpg`} alt="설화수추천제품"></img>
                    <div className="recommend_txt">
                        <h2>자음생크림</h2>
                ...
                <SwiperSlide className="swiper-slide">
                    <img src={`${process.env.PUBLIC_URL}/images/main/recommend_slide03.jpg`} alt="설화수추천제품"></img>
                    <div className="recommend_txt">
                        <h2>자음생세럼</h2>
                ...
                <SwiperSlide className="swiper-slide">
                    <img src={`${process.env.PUBLIC_URL}/images/main/recommend_slide04.jpg`} alt="설화수추천제품"></img>
                    <div className="recommend_txt">
                        <h2>순행클렌징오일</h2>
                ...
                <SwiperSlide className="swiper-slide">
                    <img src={`${process.env.PUBLIC_URL}/images/main/recommend_slide05.jpg`} alt="설화수추천제품"></img>
                    <div className="recommend_txt">
                        <h2>순행클렌징폼</h2>
                ...
                <SwiperSlide className="swiper-slide">
                    <img src={`${process.env.PUBLIC_URL}/images/main/recommend_slide06.jpg`} alt="설화수추천제품"></img>
                    <div className="recommend_txt">
                        <h2>백삼팩</h2>
            ...
            <button type="button" className="swiper-button swiper-button-sec2 swiper_button_prev" style={{backgroundImage:SwiperPrevBtn}}></button>
            <button type="button" className="swiper-button swiper-button-sec2 swiper_button_next" style={{backgroundImage:SwiperNextBtn}}></button>
