...
function YunjoSec09({mobile,pc}) {
   ...
   const [bgImg, setBgImg] = useState(
        mobile?`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/shadowCream_m.png`:`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/shadowCream_pc.png`
    );
    useEffect(()=>{
        const handleResize = () => {
            const newBgImg = window.innerWidth <= 767
                ? `${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/shadowCream_m.png`
                : `${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/shadowCream_pc.png`;
            setBgImg(newBgImg);
        };
        ...
        <div className="cream_text_wrap">
            ...
            <div className="product_set">
                ...
                <li className="product01" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                    ...
                    <picture>
                        <source srcSet={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/yunjo_product01_pc.png`} media="(min-width:768px)"/>
                        <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/yunjo_product01_m.png`} alt="제품1"/>
                    </picture>
                    </div>
                    <h2>윤조에센스 6세대</h2>
                ...
                <li className="product02" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="400">
                    ...
                    <picture>
                        <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/yunjo_product02_m.png`} alt="제품2"/>
                    </picture>
                    </div>
                    <h2>첫 설화수 세트</h2>
                ...
                <li className="product03" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="600">
                    ...
                    <picture>
                        <source srcSet={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/yunjo_product03_pc.png`} media="(min-width:768px)"/>
                        <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/yunjo_product03_m.png`} alt="제품3"/>
                    </picture>
                    </div>
                    <h2>설화수 베스트셀러 컬렉션</h2>
