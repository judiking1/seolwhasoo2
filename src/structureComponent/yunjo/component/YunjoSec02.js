    ...
    <section className="yunjo_sec02">
      <div className="yunjo_first_care">
        <div className="first_care_img" data-aos="fade-down" data-aos-duration="2200" data-aos-delay="400">
          <picture>
            <source srcSet={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/first_care_pc.png`} media="(min-width: 768px)"/>
            <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/first_care_m.png`} alt="설화수 로션"/>
          </picture>
        </div>
