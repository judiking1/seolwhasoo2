  ...
  return (
    <section className="yunjo_sec06">
        <div className="ginseng_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200">
            <picture>
                <source srcSet={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/ginseng_pc.png`} media="(min-width:768px)"/>
                <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/ginseng_m.png`} alt="윤조 인삼"/>
            </picture>
        </div>
