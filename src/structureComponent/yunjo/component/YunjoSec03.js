  ...
  return (
    <div id="yunjo_sec03">
        ...
        <section className="yunjo_essence_img" data-aos="zoom-out" data-aos-duration="1500">
            <picture>
                <source src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_m/yunjo_essence_m.png`} media="(max-width: 768px)"/>
                <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/yunjo_essence_pc.png`} alt="윤조에센스"/>
            </picture>
        </section>
    </div>
  )
