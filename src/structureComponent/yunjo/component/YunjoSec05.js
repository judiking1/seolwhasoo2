  ...
  return (
    <section className="yunjo_sec05">
        <div className="detail_sec01">
            ...
            <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/towelWoman_m.png`} alt="수건으로닦는여자" data-aos="fade-up" data-aos-duration="1100" data-aos-offset="350"/>
        </div>
        <div className="detail_sec02" data-aos="fade-up" data-aos-duration="1100" data-aos-offset="400" >
            ...
            <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/lotionWoman_m.png`} alt="로션들고있는여자"/>
            <h2 className="pc">
                윤조에센스,<br/>
                피부 능력을 깨우다.
            </h2>
