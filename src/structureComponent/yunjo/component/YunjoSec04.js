...
function YunjoSec04({videoMobile, videoPc}) {
  const [videosource, setVideoSource] = useState(
    videoMobile ? `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video02_m.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video02_pc.mp4`,
    videoPc ? `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video02_pc.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video02_m.mp4`
  );
  useEffect(() => {
    const videoPlay = () => {
      const videoResizer = window.innerWidth <= '767'
      ? `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video02_m.mp4`
      : `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video02_pc.mp4`
