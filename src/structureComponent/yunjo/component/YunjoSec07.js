  ...
  return (
    <section className="yunjo_sec07">
        <div className="yunjo_sec07_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200">
            <picture>
                <source srcSet={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/threeLotion_pc.png`} media="(min-width:768px)"/>
                <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/threeLotion_m.png`} alt="윤조로션"/>
            </picture>
        </div>
