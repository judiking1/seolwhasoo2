...
function YunjoSec08({videoMobile, videoPc}) {
    const [videoSource, setVideoSource] = useState(
        videoMobile ? `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video03_m.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video03_pc.mp4`,
        videoPc ? `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video03_pc.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video03_m.mp4`
    );
    useEffect(() => {
        const videoPlay = () => {
    ...
    <div className="yunjo_sec08">
        <section className="essence_cover">
            <div className="cover_img" data-aos="zoom-out" data-aos-duration="2000" data-aos-offset="300">
                <picture>
                    <source srcSet={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_pc/womanFace_pc.png`} type="image/png" media="(min-width:768px)"/>
                    <img src={`${process.env.PUBLIC_URL}/images/yunjo/yunjo_mobile/womanFace_m.png`} alt="에센스 바르는 여성"/>
                </picture>
            </div>
