...
function YunjoSec01({videoMobile, videoPc}) {
    ...
    const [videoSource, setVideoSource] = useState(
      videoMobile? `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video01_m.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video01_pc.mp4`,
      videoPc? `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video01_pc.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video01_m.mp4`
    );
    useEffect(() => {
      const videoPlay = () => {
          const videoResizer =
            window.innerWidth <= '767'? `${process.env.PUBLIC_URL}/media/yunjo_video/video_m/yunjo_video01_m.mp4` : `${process.env.PUBLIC_URL}/media/yunjo_video/video_pc/yunjo_video01_pc.mp4`;
